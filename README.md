...
I built a highly-performant, single-page React application powered by Vite that visualizes countdowns dynamically. The core philosophy was to make the abstract concept of waiting for an event feel tangible through visual hierarchy. 
...
## Time Spent
Approximately ~1.5 hours from initial Vanilla JS scoping, through the React/Mantine refactor, to the final styling polish.
